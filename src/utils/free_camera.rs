...
use crate::{
    camera::{CameraHolder, MainCamera},
    input_handling::KeyBindings,
    AppState,
};
...
fn move_camera(
    ...
    camera_transform.translation += horizontal_movement_translation * fixed_time.delta_secs();
    ...
    camera_transform.translation += vertical_movement_translation * fixed_time.delta_secs();
}
