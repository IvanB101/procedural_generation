...
impl Plugin for PostProcessPlugin {
    fn build(&self, app: &mut App) {
        ...
        .add_systems(PostStartup, camera_setup)
...
fn camera_setup(mut commands: Commands, main_camera_q: Query<Entity, With<MainCamera>>) {
    commands
        .entity(
            main_camera_q
                .get_single()
                .expect("No 'MainCamera' to insert 'PostProcessSettings'"),
        )
